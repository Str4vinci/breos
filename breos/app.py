...
class App:
    ...
    config : dict
        ...
        - ``slope`` (None) — tilt angle in degrees; None = auto from latitude.
        ...
        - ``calendar_model`` ("naumann_lam_calibrated") — battery calendar model.
    ...
    def __init__(self, config: dict) -> None:
        ...
        # Resolve slope / azimuth
        self._slope = cfg["slope"] if cfg["slope"] is not None else estimate_optimal_tilt(self._lat)
