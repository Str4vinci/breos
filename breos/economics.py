...
def cost_analysis_projection(
    ...
    if yearly_summary_df is not None and not yearly_summary_df.empty:
        ...
        discount_factors = 1 / ((1 + discount_rate) ** (proj['Year'] - 1))
        ...
        proj['Revenue_Export'] = yearly_data['Export_kWh'].values * costs['electricity_sold_cost'] * sell_inflation_factors
        ...
        proj['Cost_System_Cumulative'] = (
            costs['total_initial_cost'] + proj['Cost_System_Annual'].cumsum()
        )
        ...
        proj['Cost_System_Cumulative_NPV'] = (
            costs['total_initial_cost'] + proj['Cost_System_Annual_NPV'].cumsum()
        )
