...
These notes preserve context for maintainers and contributors. They describe
intent or implementation history, not necessarily current public behavior.
Current capabilities belong in `docs/`; future release intent belongs in
`ROADMAP.md`.
