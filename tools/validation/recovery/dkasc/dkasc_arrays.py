...
ARRAYS: dict[str, Array] = {
    "16A": Array(
        "16A", 100, "16A BP Solar 2.0 kW poly, fixed, north", BP3165J, 12, 1.98, 20.0, 0.0, 2.5, 0.941, "2008-11-11"
    ),
    "16D": Array(
        "16D", 81, "16D BP Solar 2.0 kW poly, fixed, west", BP3165J, 12, 1.98, 20.0, 270.0, 2.5, 0.941, "2008-11-11"
    ),
    "12": Array(
        "12", 84, "12 BP Solar 5.1 kW mono, fixed, north", BP4170N, 30, 5.10, 20.0, 0.0, 6.0, 0.955, "2008-11-11"
    ),
    "13": Array(
        "13", 92, "13 Trina 5.25 kW mono, fixed, north", TSM175DC01, 30, 5.25, 20.0, 0.0, 6.0, 0.955, "2009-01-08"
    ),
    ...
    "1A": Array(
        "1A",
        91,
        "1A Trina 10.5 kW mono, dual-axis tracking",
        TSM175DC01,
        60,
        10.50,
        0.0,
