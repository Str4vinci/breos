...
| `slope` | auto | Tilt angle in degrees (auto-estimated from latitude) |
...
| `calendar_model` | `"naumann_lam_calibrated"` | Battery calendar aging model |
...
pv_dc = calculate_pv_production_dc(weather, location, slope=35, surface_azimuth=180, n_modules=10)
# ...
```
